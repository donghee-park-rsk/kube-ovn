...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1.SchemeGroupVersion.WithResource("vpc-edge-routers"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Kubeovn().V1().VpcEdgeRouters().Informer()}, nil
